...
const CyberSecurityBanner = () => {
  return (
    <div className="container mx-auto px-4 md:px-8 py-8">
      <section className="rounded-2xl overflow-hidden bg-gradient-to-r from-[#002a4e] to-[#004b7d] text-white relative shadow-xl mx-2 md:mx-6 transform hover:scale-[1.01] transition-transform duration-300">
