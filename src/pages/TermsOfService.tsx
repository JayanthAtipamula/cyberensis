        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8 sm:p-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">2. Services</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">3. Use of Website</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">5. User Accounts</h2>
              <p className="mb-4">
                Some parts of our website may require you to create an account. You are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer. You agree to accept responsibility for all activities that occur under your account or password.
              </p>
              
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">6. Limitation of Liability</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">7. Indemnification</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">8. Governing Law</h2>
              <p className="mb-4">
                These Terms shall be governed and construed in accordance with the laws of India, without regard to its conflict of law provisions. Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.
              </p>
              
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">9. Changes to Terms</h2>
              <p className="mb-4">
                We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.
              </p>
              
              <h2 className="text-xl font-semibold mt-8 mb-4 text-gray-900">10. Contact Us</h2>
              <p className="mb-4">
