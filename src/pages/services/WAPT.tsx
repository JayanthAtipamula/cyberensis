      ...
      <div className="container mx-auto px-6 lg:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold dark:text-white">What is Web Application Penetration Testing?</h2>
          </div>
...
const ServiceBenefits = () => {
  ...
  return (
    <section className="py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-6 lg:px-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-10 text-center dark:text-white">Benefits of Our WAPT Services</h2>
...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-16 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-6 lg:px-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-10 text-center dark:text-white">Why Choose Our WAPT Services</h2>
